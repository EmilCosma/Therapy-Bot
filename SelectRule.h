 ...
 char* selectRule(int ruleNumber)
{
	...
	int randomNumber = rand();
		...
		case 36:
		{
			...
			strcpy_s(responses[1], "The concept of showing appreciation, however, can be challenging. Saying thank you every 5 minutes when your partner does something can feel disingenuous. Developing alternative ways to show appreciation may help keep a level of sincerit yand can promote a sense of awareness for the things your partner does.");
